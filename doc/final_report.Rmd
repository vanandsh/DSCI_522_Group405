...
We summarize the differences in a room type in a certain neighbourhood group same in a table where the number of listings, the mean price per night and the maximum price per night are shown. 
