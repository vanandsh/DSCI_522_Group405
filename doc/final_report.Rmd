...
We see the distribution of our target variable price to get a general sense of the prices in all neighbourhoods of New York. There is an outlier that stands at $10000, other than which all prices are mostly lesser than 1000, with an average of $152 per night. 
...
We summarize the same in a table where the prices are grouped using neighbourhood group and room type, and their mean and max prices are calculated.
...
- The data we have does not capture the season and months of the year. There could be a high correlation between the prices and the season of the year. In particular seasons and holidays, we can expect tourist inflows to be much higher than normal thereby inflating the listing prices

- Price of Airbnb listings fluctuate throughout the year, this too is not captured and limits us from probing into this further

- A rating feature would have helped our models to predict the prices better. In the dataset we are using, we do have reviews but it would require us to do sentiment analysis on each review to get a pulse of how the Airbnb listing compares to others
