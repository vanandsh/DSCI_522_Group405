...
The mean price per night per night based by room type is as we would have expected. The prices of the entire home/apts is higher than private room followed by  shared accomodations. 

From the different neighbourhoods, Manhattan is the most expensive one and Bronx has the lowest rates. The neighbourhood group and type of room will be important features in predicting price.
